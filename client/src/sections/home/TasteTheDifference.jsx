...
const TasteTheDifference = () => {
  return (
    <Container fluid id="taste-the-difference" style={styles.root}>
      <Row>
          ...
          <Row className="pb-2">
            ...
            <Col className="pt-5" xs={12} md={8}>
              <Container>
                ...
                <p>
                  Feel good about what you eat! Explore a world of taste beyond
                  ordinary meals, made with passion by local heroes.
                </p>
              </Container>
            </Col>
          </Row>
